        ...
        <nav class="navbar navbar-expand-lg navbar-dark" style="padding-bottom: 4.5rem">
            ...
            <div class="collapse navbar-collapse" id="navbarNav1">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link titleEntries" href="selectSport.php">Sports</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link titleEntries active" href="bookSlot.php">Membership</a>
                    </li>
                </ul>
            </div>
        </nav>
            ...
            <form action="update.php" method="POST" >
                ...
                <div class="right">
                    <b><h1 style="margin-top: 5%;">Membership</h1></b>
                    ...
                    <div class="inputs">
                        ...
                        <br />
                        <br/>
                        <span for="mtype" style="width: 200px;color: #b0b3b9"> Membership Type</span>
                        <input type="text" placeholder="eg - Gold/Platinum/Silver" id="uid" name="membership" style="margin-top:-2px" />
                        <br />
